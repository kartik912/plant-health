...
const NavBar = () => {
  ...
  return (
    <div className={` flex flex-col items-center bg-[#27667B] w-[100%]  md:min-w-[20vw] md:h-full `}>
        ...
        <div className="md:fixed right md:mt-35 gap-3 flex md:flex-col text-center md:text-xl flex-wrap justify-center text-white">
          <Link to="/dashboard" className='font-semibold mb-4 flex items-center md:gap-2'><HiExternalLink /> Dashboard</Link>
          <Link to="/camera" className='font-semibold mb-4 flex items-center md:gap-2'><HiExternalLink /> Camera</Link>
